document.addEventListener('DOMContentLoaded', function() {
    ...
    const musicTracks = {
        lofi: [
            { title: 'Chill Vibes', src: 'music/lofi/chill-vibes.mp3' },
            { title: 'Coffee Shop', src: 'music/lofi/coffee-shop.mp3' },
            { title: 'Rainy Day', src: 'music/lofi/rainy-day.mp3' }
        ],
        nature: [
            { title: 'Forest Sounds', src: 'music/nature/forest.mp3' },
            { title: 'Ocean Waves', src: 'music/nature/ocean.mp3' },
            { title: 'Rainfall', src: 'music/nature/rain.mp3' }
        ],
        classical: [
            { title: 'Mozart', src: 'music/classical/mozart.mp3' },
            { title: 'Beethoven', src: 'music/classical/beethoven.mp3' },
            { title: 'Bach', src: 'music/classical/bach.mp3' }
        ],
        whiteNoise: [
            { title: 'White Noise', src: 'music/white-noise/white.mp3' },
            { title: 'Pink Noise', src: 'music/white-noise/pink.mp3' },
            { title: 'Brown Noise', src: 'music/white-noise/brown.mp3' }
        ]
    };
