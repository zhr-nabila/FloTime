            ...
            <form method="POST" class="mb-4 px-3 py-4 rounded-4 shadow bg-white border border-light-subtle premium-form">
                <div class="row align-items-end g-3">
                    <div class="col-md-5">
                        ...
                        <input type="text" name="title" class="form-control form-control-sm rounded-4 shadow-sm" placeholder="Tulis tugasmu di sini..." required>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">Deadline</label>
                        <input type="date" name="deadline" class="form-control form-control-sm rounded-4 shadow-sm" required>
                    </div>
                    <div class="col-md-3 d-grid">
                        <button type="submit" name="add_task" class="btn btn-gradient shadow fw-semibold py-2 rounded-2">+ Tambah Tugas</button>
                    </div>
                </div>
            </form>
