...
<div class="main-content">
    ...
    <div class="container mt-4">
        ...
        <form method="POST" class="mb-4 row g-2 align-items-center justify-content-start">
    <div class="col-lg-4 col-md-5 col-sm-12">
        <input type="text" name="title" class="form-control rounded-pill shadow-sm px-4 py-2" placeholder="Judul tugas" required>
    </div>
    <div class="col-lg-3 col-md-4 col-sm-12">
        <input type="date" name="deadline" class="form-control rounded-pill shadow-sm px-4 py-2" required>
    </div>
    <div class="col-lg-2 col-md-3 col-sm-12">
        <button type="submit" name="add_task" class="btn btn-dark rounded-pill w-100 py-2 d-flex align-items-center justify-content-center gap-2 add-btn">
            <i class="bi bi-plus-circle-fill fs-5"></i> Tambah
        </button>
    </div>
</form>
...
<?php if ($result->num_rows > 0): ?>
    ...
    <form method="POST">
        ...
        <button type="submit" name="delete_task" class="btn btn-outline-danger btn-sm rounded-circle delete-btn">
