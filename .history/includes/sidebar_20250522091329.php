...
<div class="sidebar d-flex flex-column">
    ...
    <nav class="nav flex-column px-3">
        ...
        <a class="nav-link <?= ($activePage == 'todo') ? 'active' : '' ?>" href="todo.php">
         ...
         <a class="nav-link <?= ($activePage == 'pomodoro') ? 'active' : '' ?>" href="pomodoro.php">
            <i class=" <a class="nav-link <?= ($activePage == 'pomodoro') ? 'active' : '' ?>" href="pomodoro.php">
            <i class="bi bi-person"></i> Pomodoro
        </a>"></i> Pomodoro
        </a>
