...
<div class="sidebar d-flex flex-column">
    ...
    <nav class="nav flex-column px-3">
        ...
        <!-- Tambahkan menu Hapus Akun di sini -->
        <div class="mt-auto"> <!-- Gunakan mt-auto untuk mendorong ke bawah -->
            <a class="nav-link text-danger delete-account" href="delete_account.php">
