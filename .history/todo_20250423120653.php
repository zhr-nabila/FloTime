...
<div class="main-content">
    ...
    <div class="row align-items-end g-3">
        <div class="col-md-5">
            ...
            <input type="text" name="title" class="form-control form-control-lg rounded-3 shadow-sm" placeholder="Tulis tugasmu di sini..." required>
        </div>
        <div class="col-md-4">
            <label class="form-label fw-semibold">Deadline</label>
            <input type="date" name="deadline" class="form-control form-control-lg rounded-3 shadow-sm" required>
        </div>
        <div class="col-md-3 d-grid">
            <button type="submit" name="add_task" class="btn btn-gradient shadow fw-bold py-3 rounded-3">+ Tambah Tugas</button>
        </div>
    </div>
</form>
