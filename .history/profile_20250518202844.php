        ...
        <div class="content">
            ...
            <form method="POST" enctype="multipart/form-data" class="form-profile">
                ...
                <div>
                    ...
                    <input type="text" name="name" id="name" class="input-profile glass-input" value="<?= htmlspecialchars($user['name']) ?>" required />
                </div>
                <div>
                    <label for="email" class="form-label">Email</label>
                    <input type="email" name="email" id="email" class="input-profile glass-input" value="<?= htmlspecialchars($user['email']) ?>" required />
                </div>
                <div>
                    <label for="photo" class="form-label">Upload Foto Baru</label>
                    <label class="upload-box glass-input" for="photo">
