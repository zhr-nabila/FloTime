...
if (isset($_POST['add_task'])) {
    ...
    // Redirect ke todo.php setelah task ditambahkan
...
// Ambil semua task milik user saat ini
...
<div class="header">
    <div class="titlFe">Todo List</div>
    <form method="GET" class="search-bar d-flex align-items-center">
    <input type="text" name="search" class="form-control me-2" placeholder="Search task..." value="<?= htmlspecialchars($search) ?>">
