                ...
                <div class="music-player">
                    <div class="music-header">
                        ...
                        <button id="musicToggle" class="music-toggle">
                            <i class="bi bi-music-player"></i> Toggle Music
                        </button>
                    </div>
                    ...
                    <div class="music-albums">
                        ...
                        <div class="album active" data-album="lofi">
                            <div class="album-cover" style="background-image: url('https://source.unsplash.com/random/300x300/?lofi,music')">
                        ...
                        <div class="album" data-album="nature">
                            <div class="album-cover" style="background-image: url('https://source.unsplash.com/random/300x300/?nature,forest')">
                                <div class="album-overlay">
                                    <i class="bi bi-play-circle"></i>
                                </div>
                            </div>
