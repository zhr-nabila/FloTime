...
<body>
    ...
    <div class="main-content">
        ...
        <form method="POST" enctype="multipart/form-data" class="form-profile row g-4">
    <!-- KIRI: FOTO -->
    <div class="col-md-4 text-center">
        <label class="form-label">Foto Profil</label><br>
        <?php if ($user['photo']) : ?>
            <img src="uploads/<?= htmlspecialchars($user['photo']) ?>" alt="Foto" class="photo-user mb-3">
        <?php else : ?>
    ...
    <div class="col-md-8">
        ...
        <div class="mb-3">
            ...
            <label for="photo" class="custom-file-upload">
                Klik di sini untuk pilih foto
            </label>
            <input type="file" name="photo" id="photo" class="input-profile d-none">
        </div>
