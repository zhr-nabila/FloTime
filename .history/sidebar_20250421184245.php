...
<div class="sidebar d-flex flex-column">
    <div class="px-4 d-flex align-items-center mb-4">
        <div class="user-avatar"><?= strtoupper(substr($email, 0, 1)) ?></div> <!-- Menampilkan huruf pertama dari email pengguna -->
        <div class="ms-2">
            <div class="fw-semibold">User Dashboard</div>
            <div class="small text-white-50"><?= htmlspecialchars($email) ?></div> <!-- Menampilkan email pengguna -->
        </div>
    </div>
