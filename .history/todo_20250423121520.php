...
<div class="main-content">
    ...
    <div class="col-lg-4 col-md-5 col-sm-12">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <input type="text" name="title" class="form-control rounded-pill px-4 py-2" placeholder="Judul tugas" required>
            </div>
        </div>
    </div>
    <div class="col-lg-3 col-md-4 col-sm-12">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <input type="date" name="deadline" class="form-control rounded-pill px-4 py-2" required>
            </div>
        </div>
    </div>
