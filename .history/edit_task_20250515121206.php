    ...
    <div class="edit-form-container">
        ...
        <form method="POST">
            <div class="mb-3">
                ...
                <input type="text" name="title" class="form-control glass-input" value="<?= htmlspecialchars($row['title']) ?>" required>
            </div>
            <div class="mb-6">
                <label class="form-label fw-semibold">Deadline</label>
                <input type="date" name="deadline" class="form-control glass-input" value="<?= $row['deadline'] ?>" required>
            </div>
