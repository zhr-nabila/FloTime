    ...
    <div class="edit-form-container">
        ...
        <form method="POST">
            ...
            <div class="d-flex gap-2">
                <button type="submit" name="update_task" class="btn btn-gradient w-100 rounded-4 d-flex align-items-center justify-content-center gap-2 py-2">
                    <i class="bi bi-save2"></i> Simpan Perubahan
                </button>
                <a href="todo.php" class="btn btn-outline-secondary w-50 rounded-4 d-flex align-items-center justify-content-center gap-2 py-2">
