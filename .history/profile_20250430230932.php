        ...
        <div class="content p-5">
            <form method="POST" enctype="multipart/form-data" class="form-profile">
                <div class="mb-3">
                    ...
                    <?php if ($user['photo']) : ?>
                        <img src="uploads/<?= htmlspecialchars($user['photo']) ?>" alt="Foto" class="photo-user" style="max-height: 150px; border-radius: 10px;">
                    <?php else : ?>
                ...
                <button type="submit" class="btn btn-gradient shadow fw-semibold rounded-5">Simpan Perubahan</button>
            </form>
        </div>
    </div>
</body>
