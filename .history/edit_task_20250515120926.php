    ...
    <div class="edit-form-container">
        ...
        <form method="POST">
            <div class="mb-3">
                ...
                <input type="text" name="title" class="form-control form-control-lg rounded-5 shadow-sm" value="<?= htmlspecialchars($row['title']) ?>" required>
            </div>
            <div class="mb-4">
                <label class="form-label fw-semibold">Deadline</label>
                <input type="date" name="deadline" class="form-control form-control-lg rounded-5 shadow-sm" value="<?= $row['deadline'] ?>" required>
            </div>
