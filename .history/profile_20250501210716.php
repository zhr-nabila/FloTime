...
<div class="main-content">
    ...
    <div class="content">
        ...
        <div class="profile-left">
            ...
            <?php else : ?>
                <div class="user-avatar-lg"><?= strtoupper(substr($user['name'] ?: $user['email'], 0, 1)) ?></div>
            <?php endif; ?>
            <?php if ($user['photo']) : ?>
                <div class="form-check mt-3">
                    <input type="checkbox" class="form-check-input" id="delete_photo" name="delete_photo" form="form-profile">
                    <label class="form-check-label" for="delete_photo">Hapus Foto</label>
                </div>
            <?php endif; ?>
        </div>

        <!-- KANAN: FORM -->
        <form method="POST" enctype="multipart/form-data" class="form-profile" id="form-profile">
            <div>
            ...
            <div>
                ...
                <input type="file" name="photo" id="photo" class="input-profile">
            </div>
